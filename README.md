...
- Когда скрипт запускается, в лог будет добавлено следующее сообщение:
  ```
  2025-01-01 12:00:00 - Запуск скрипта для домена exemple.com
  ```
- В случае успешного выполнения скрипта:
  ...
  2025-01-01 12:00:15 - Скрипт успешно завершен. Сертификат и ключ для домена exemple.com сохранены в ./adguard/confdir.
  ```
...
1. **Лог при успешном выполнении:**
   ...
   2025-01-01 12:00:10 - Сертификат и ключ для домена exemple.com извлечены.
   ...
   2025-01-01 12:00:30 - Скрипт успешно завершен. Сертификат и ключ для домена exemple.com сохранены в ./adguard/confdir.
   ```

2. **Лог при ошибке:**
   ```
   2025-01-01 12:01:00 - Файл /home/suave/docker/traefik/letsencrypt/acme.json не найден!
   2025-01-01 12:01:05 - Не удалось извлечь сертификат или ключ для домена exemple.com из /home/suave/docker/traefik/letsencrypt/acme.json!
   ```
